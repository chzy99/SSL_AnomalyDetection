...
class DeepSVDD(object):
    ...
    def train(self, encoder, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
              lr_milestones: tuple = (), batch_size: int = 128, weight_decay: float = 1e-6, device: str = 'cuda',
              n_jobs_dataloader: int = 0):
        """Trains the Deep SVDD model on the training data."""

        self.optimizer_name = optimizer_name
        self.trainer = DeepSVDDTrainer(encoder, self.objective, self.R, self.c, self.nu, optimizer_name, lr=lr,
    ...
    def pretrain(self, encoder, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
                 lr_milestones: tuple = (), batch_size: int = 128, weight_decay: float = 1e-6, device: str = 'cuda',
                 n_jobs_dataloader: int = 0):
        ...
        self.ae_trainer = AETrainer(encoder, optimizer_name, lr=lr, n_epochs=n_epochs, lr_milestones=lr_milestones,
